# TUGAS VIDEO — MODUL 2: PEMBENTUKAN CITRA (IMAGE FORMATION)

---

## Deskripsi Tugas

Buatlah video laporan menyeluruh yang mencakup **penjelasan materi**, **seluruh 20 percobaan praktikum**, dan **project** Modul 2. Video mendokumentasikan pemahaman tentang pembentukan citra, transformasi geometri, kalibrasi kamera, dan konsep fotometri.
...
| **Hardware Demo** | Wajib untuk percobaan kalibrasi — rekam proses pengambilan foto checkerboard |
...
2. Sebutkan judul modul: **"Pembentukan Citra (Image Formation)"**.
3. Sebutkan tujuan pembelajaran.
4. Overview singkat apa yang akan ditampilkan dalam video.

### B. PENJELASAN MATERI (5–8 menit)
1. Jelaskan konsep pembentukan citra (image formation) **dengan bahasa sendiri**.
2. Gambarkan hierarki transformasi 2D (translasi → rigid → similarity → affine → projective).
3. Jelaskan model pinhole camera dan matriks intrinsik.
4. Jelaskan konsep distorsi lensa (barrel, pincushion).
5. Jelaskan gamma correction dan efeknya terhadap gambar.
6. Jelaskan konsep sampling, aliasing, dan anti-aliasing.
...
6. Jika ada fitur hardware (webcam/kalibrasi), **rekam proses nyata**.
...
| Item | Bonus |
|------|-------|
| Demo hardware kalibrasi kamera secara nyata | +3 |
| Visual aids (diagram transformasi, slide) | +3 |
| Editing profesional (intro, transisi, outro) | +2 |
...
- **Penamaan**: `NIM_Nama_Video_Modul02`
