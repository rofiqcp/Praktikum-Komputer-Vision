# TUGAS VIDEO — MODUL 5: MODEL FITTING DAN OPTIMASI

---

## Deskripsi Tugas

Buatlah video laporan menyeluruh yang mencakup **penjelasan materi**, **seluruh 20 percobaan praktikum**, dan **project** Modul 5. Dokumentasikan pemahaman tentang model fitting, estimasi robust, dan teknik optimasi dalam computer vision.
...
2. Sebutkan judul modul: **"Model Fitting dan Optimasi"**.
3. Sebutkan tujuan pembelajaran.
4. Overview singkat apa yang akan ditampilkan dalam video.

### B. PENJELASAN MATERI (5–8 menit)
1. Jelaskan konsep least squares (OLS, WLS, TLS) **dengan bahasa sendiri**.
2. Jelaskan RANSAC: mengapa diperlukan, algoritma, contoh visual.
3. Jelaskan Hough Transform untuk deteksi garis dan lingkaran.
4. Jelaskan homografi dan kegunaannya.
5. Jelaskan cross-validation dan model selection untuk fitting.
6. Jelaskan regularisasi dan cross-validation.
...
- Percobaan 10: IRLS Robust Fitting
...
- Percobaan 15: K-Means Clustering
...
| Item | Bonus |
|------|-------|
| Animasi/visualisasi proses RANSAC atau Hough voting | +3 |
| Visual aids (diagram pipeline, grafik konvergensi) | +3 |
...
- **Penamaan**: `NIM_Nama_Video_Modul05`
