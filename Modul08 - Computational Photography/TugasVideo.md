# TUGAS VIDEO MODUL 8: COMPUTATIONAL PHOTOGRAPHY
...
| 5 | Seamless Cloning | Normal, mixed, monochrome clone |
...
| 11 | Neural Style Transfer | Style models, content+style loss |
| 12 | Image Colorization DNN | LAB prediction, grayscale→color |
