...
if img is None:
    # Jika gambar tidak ditemukan, buat gambar sintetis
    print("[INFO] scene_pemandangan.png tidak ditemukan, membuat gambar sintetis...")
    # Membuat gambar sintetis dengan garis dan lingkaran
    img = np.ones((400, 600, 3), dtype=np.uint8) * 128
    # Menambahkan beberapa objek untuk detail
    cv2.rectangle(img, (50, 50), (200, 200), (200, 150, 100), -1)
    cv2.circle(img, (400, 150), 80, (100, 200, 150), -1)
    cv2.line(img, (0, 300), (600, 300), (80, 80, 200), 3)
    # Menambahkan noise halus untuk simulasi tekstur
