...
if img is None:
    # Jika gambar tidak ditemukan, buat gambar sintetis berwarna-warni
    print("[INFO] scene_pemandangan.png tidak ditemukan, membuat gambar sintetis...")
    # Membuat gambar sintetis pemandangan
    img = np.zeros((400, 600, 3), dtype=np.uint8)
    # Membuat langit biru di bagian atas
    img[:200, :, 0] = 180
    img[:200, :, 1] = 130
    img[:200, :, 2] = 80
    # Membuat rumput hijau di bagian bawah
    img[200:, :, 0] = 40
    img[200:, :, 1] = 160
    img[200:, :, 2] = 60
    # Menambahkan noise halus
